...
from ir_oop import SearchEngine, SimpleCountRanker, NewsArticle, WebPage
...
class TestSystemWorkflow(unittest.TestCase):
    def test_end_to_end_add_search_save_reload_search(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            engine.add_document(NewsArticle("n1", "Safety", "security patrol increased", "UMD News", "2025-12-01"))
            engine.add_document(WebPage("w1", "Hours", "library open late finals week", "https://example.com"))
